...
public class PseudoAuthenticationHandler implements AuthenticationHandler {
   ...
   * <p/>
   * This method is invoked by the {@link org.apache.hadoop.security.authentication.server.AuthenticationFilter#init} method.
   *
   ...
   * @throws java.io.IOException it is never thrown.
   * @throws org.apache.hadoop.security.authentication.client.AuthenticationException it is never thrown.
   */
  @Override
   ...
   * <p/>
   * It extracts the {@link org.apache.hadoop.security.authentication.client.PseudoAuthenticator#USER_NAME} parameter from the query string and creates
   * an {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} with it.
   * <p/>
   * If the HTTP client request does not contain the {@link org.apache.hadoop.security.authentication.client.PseudoAuthenticator#USER_NAME} parameter and
   * the handler is configured to allow anonymous users it returns the {@link org.apache.hadoop.security.authentication.server.AuthenticationToken#ANONYMOUS}
   * token.
   * <p/>
   * If the HTTP client request does not contain the {@link org.apache.hadoop.security.authentication.client.PseudoAuthenticator#USER_NAME} parameter and
   * the handler is configured to disallow anonymous users it throws an {@link org.apache.hadoop.security.authentication.client.AuthenticationException}.
   *
   * @param request the HTTP client request.
   * @param response the HTTP client response.
   *
   ...
   * @throws org.apache.hadoop.security.authentication.client.AuthenticationException thrown if HTTP client request was not accepted as an authentication request.
   */
  @Override
