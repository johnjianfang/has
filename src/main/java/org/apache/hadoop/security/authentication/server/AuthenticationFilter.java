...
/**
 * The {@link org.apache.hadoop.security.authentication.server.AuthenticationFilter} enables protecting web application resources with different (pluggable)
 * authentication mechanisms.
 * <p/>
 * Out of the box it provides 2 authentication mechanisms: Pseudo and Kerberos SPNEGO.
 * <p/>
 * Additional authentication mechanisms are supported via the {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler} interface.
 * <p/>
 * This filter delegates to the configured authentication handler for authentication and once it obtains an
 * {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} from it, sets a signed HTTP cookie with the token. For client requests
 ...
 * {@link org.apache.hadoop.security.authentication.server.PseudoAuthenticationHandler}, 'kerberos' is short for {@link org.apache.hadoop.security.authentication.server.KerberosAuthenticationHandler}, otherwise
 * the full class name of the {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler} must be specified.</li>
 ...
 * </ul>
 * <p/>
 * The rest of the configuration properties are specific to the {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler} implementation and the
 * {@link org.apache.hadoop.security.authentication.server.AuthenticationFilter} will take all the properties that start with the prefix #PREFIX#, it will remove
...
public class AuthenticationFilter implements Filter {
  ...
  private static Logger LOG = LoggerFactory.getLogger(org.apache.hadoop.security.authentication.server.AuthenticationFilter.class);
   ...
   * <p/>
   * It instantiates and initializes the specified {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler}.
   * <p/>
   *
   * @param filterConfig filter configuration.
   *
   * @throws javax.servlet.ServletException thrown if the filter or the authentication handler could not be initialized properly.
   */
  @Override
   ...
   * Destroys the filter.
   * <p/>
   * It invokes the {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler#destroy()} method to release any resources it may hold.
   */
  @Override
  public void destroy() {
    if (authHandler != null) {
   ...
   * are also trimmed from the prefix. The returned {@link java.util.Properties} object is used to initialized the
   * {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler}.
   * <p/>
   ...
   *
   * @return the configuration to be used with the {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler} instance.
   *
   * @throws javax.servlet.ServletException thrown if the configuration could not be created.
   */
  ...
  /**
   * Returns the {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} for the request.
   * <p/>
   * It looks at the received HTTP cookies and extracts the value of the {@link org.apache.hadoop.security.authentication.client.AuthenticatedURL#AUTH_COOKIE}
   * if present. It verifies the signature and if correct it creates the {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} and returns
   * it.
   * <p/>
   * If this method returns <code>null</code> the filter will invoke the configured {@link org.apache.hadoop.security.authentication.server.AuthenticationHandler}
   ...
   * @throws org.apache.hadoop.security.authentication.client.AuthenticationException thrown if the token is invalid or if it has expired.
   */
   ...
   *
   * @throws java.io.IOException thrown if an IO error occurred.
   * @throws javax.servlet.ServletException thrown if a processing error occurred.
   */
  @Override
