 ...
 * <p/>
 * The {@link org.apache.hadoop.security.authentication.server.AuthenticationFilter} manages the lifecycle of the authentication handler.
 * <p/>
...
public interface AuthenticationHandler {
   ...
   * <p/>
   * This method is invoked by the {@link org.apache.hadoop.security.authentication.server.AuthenticationFilter#destroy} method.
   */
  public void destroy();
   ...
   * @throws org.apache.hadoop.security.authentication.client.AuthenticationException thrown if an Authentication error occurred.
   */
   ...
   * <p/>
   * This method is invoked by the {@link org.apache.hadoop.security.authentication.server.AuthenticationFilter} only if the HTTP client request is
   ...
   * <p/>
   * This method must return an {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} only if the the HTTP client request has
   ...
   * @param response the HTTP client response.
   *
   * @return an {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} if the HTTP client request has been authenticated,
