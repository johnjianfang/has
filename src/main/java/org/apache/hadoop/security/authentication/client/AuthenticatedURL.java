...
/**
 * The {@link org.apache.hadoop.security.authentication.client.AuthenticatedURL} class enables the use of the JDK {@link java.net.URL} class
 ...
 * <p/>
 * Additional authentication mechanisms can be supported via {@link org.apache.hadoop.security.authentication.client.Authenticator} implementations.
 * <p/>
 * The default {@link org.apache.hadoop.security.authentication.client.Authenticator} is the {@link org.apache.hadoop.security.authentication.client.KerberosAuthenticator} class which supports
 * automatic fallback from Kerberos SPNEGO to Hadoop Simple authentication.
 * <p/>
 * <code>AuthenticatedURL</code> instances are not thread-safe.
 * <p/>
 * The usage pattern of the {@link org.apache.hadoop.security.authentication.client.AuthenticatedURL} is:
 * <p/>
 * <pre>
 *
...
public class AuthenticatedURL {
  ...
  /**
   * Sets the default {@link org.apache.hadoop.security.authentication.client.Authenticator} class to use when an {@link org.apache.hadoop.security.authentication.client.AuthenticatedURL} instance
  ...
  /**
   * Returns the default {@link org.apache.hadoop.security.authentication.client.Authenticator} class to use when an {@link org.apache.hadoop.security.authentication.client.AuthenticatedURL} instance
   * is created without specifying an authenticator.
   *
  ...
  /**
   * Creates an {@link org.apache.hadoop.security.authentication.client.AuthenticatedURL}.
   */
   ...
   *
   * @param authenticator the {@link org.apache.hadoop.security.authentication.client.Authenticator} instance to use, if <code>null</code> a {@link
   * org.apache.hadoop.security.authentication.client.KerberosAuthenticator} is used.
   */
  ...
  /**
   * Returns an authenticated {@link java.net.HttpURLConnection}.
   *
   * @param url the URL to connect to. Only HTTP/S URLs are supported.
   * @param token the authentication token being used for the user.
   *
   * @return an authenticated {@link java.net.HttpURLConnection}.
   *
   * @throws java.io.IOException if an IO error occurred.
   * @throws org.apache.hadoop.security.authentication.client.AuthenticationException if an authentication exception occurred.
   */
   ...
   * <p/>
   * This method is used by {@link org.apache.hadoop.security.authentication.client.Authenticator} implementations.
   *
