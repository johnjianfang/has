...
/**
 * The {@link org.apache.hadoop.security.authentication.server.KerberosAuthenticationHandler} implements the Kerberos SPNEGO authentication mechanism for HTTP.
 * <p/>
 ...
 * {@link org.apache.hadoop.security.authentication.util.KerberosName#setRules(String)}</li>
 * </ul>
 */
public class KerberosAuthenticationHandler implements AuthenticationHandler {
  private static Logger LOG = LoggerFactory.getLogger(org.apache.hadoop.security.authentication.server.KerberosAuthenticationHandler.class);
  ...
  /**
   * It enforces the the Kerberos SPNEGO authentication sequence returning an {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} only
   ...
   * @throws org.apache.hadoop.security.authentication.client.AuthenticationException thrown if Kerberos SPNEGO sequence failed.
   */
  @Override
