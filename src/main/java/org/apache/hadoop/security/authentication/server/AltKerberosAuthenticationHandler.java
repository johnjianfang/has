...
/**
* The {@link org.apache.hadoop.security.authentication.server.AltKerberosAuthenticationHandler} behaves exactly the same way as
* the {@link org.apache.hadoop.security.authentication.server.KerberosAuthenticationHandler}, except that it allows for an
...
public abstract class AltKerberosAuthenticationHandler
  ...
  * {@link org.apache.hadoop.security.authentication.server.AuthenticationToken} only after the Kerberos SPNEGO sequence has
  ...
  */
 @Override
 public org.apache.hadoop.security.authentication.server.AuthenticationToken authenticate(HttpServletRequest request,
  ...
  * @throws org.apache.hadoop.security.authentication.client.AuthenticationException thrown if an authentication error occurs
  */
