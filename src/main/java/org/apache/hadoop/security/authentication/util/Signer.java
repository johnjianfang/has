...
public class Signer {
   ...
   *
   * @throws org.apache.hadoop.security.authentication.util.SignerException thrown if the given string is not a signed string or if the signature is invalid.
   */
